...
description: >-
  Keeps README, AGENTS.md, feature docs, .env.example, and CLAUDE.md files in sync
  with code changes in react_native/ and server/. Use after adding or changing
...
- Mission-level behavior that `README` / `AGENTS.md` / `CLAUDE.md` describe
...
- **`CLAUDE.md` files**: only if conventions or mission changed—not for every feature.
...
- No contradictory statements between README, AGENTS.md, and CLAUDE.md files.
